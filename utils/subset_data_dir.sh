...
function do_filtering {
  ...
  [ -f $srcdir/mfcc.scp ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/mfcc.scp >$destdir/mfcc.scp
  [ -f $srcdir/mfcc_cmvn.scp ] && utils/filter_scp.pl $destdir/spk2utt <$srcdir/mfcc_cmvn.scp >$destdir/mfcc_cmvn.scp
  [ -f $srcdir/hires.scp ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/hires.scp >$destdir/hires.scp
  [ -f $srcdir/hires_cmvn.scp ] && utils/filter_scp.pl $destdir/spk2utt <$srcdir/hires_cmvn.scp >$destdir/hires_cmvn.scp
